...
app.get('/team_stats', function(req, res) {
    ...
    var all_stats = 'select * from football_games;';
...
app.get('/player_info/select_player', function(req, res) {
  ...
  //console.log('2');
  var query3 = "select count(*) from (select p.id from football_players p inner join football_games g on p.id = any(g.players) where p.id = '" + player_id + "') total;";
  //console.log('3');
  db.task('get-everything', task => {
      return task.batch([
          task.any(query1),
